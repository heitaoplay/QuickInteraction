...
核心代码托管在 GitHub，Loader 只是一个极简外壳，每次刷新页面都会自动拉取最新版主脚本——原理同 Razor Wings 的做法。

1. 安装 [Tampermonkey](https://www.tampermonkey.net/)（或 Violentmonkey 等同类管理器）
2. 打开 [`loader.user.js`](loader.user.js)（Raw），Tampermonkey 自动弹出安装提示，点「安装」
...
[![Install Loader](https://img.shields.io/badge/Install-Loader%20模式-FF5C7A?logo=tampermonkey&logoColor=white)](https://github.com/heitaoplay/QuickInteraction/raw/main/loader.user.js)
