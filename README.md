...
[![Version](https://img.shields.io/badge/version-0.7.27-FF5C7A)](https://github.com/heitaoplay/QuickInteraction/commits)
...
- **人物浮层选择**：点击面板左侧 ◀ 小三角按钮，在浮层里先选人物、再选身体部位（BC 原生矩形 Zone 地图），适合不习惯游戏内线框的场景
